...
public class Display3dmodelActivity extends Activity {
    ...
    private static final float ASSET_DISPLAY_SIZE = 14;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display3dmodel);
        glView = (MyGLSurfaceView)findViewById(R.id.my_gl_surface_view);
        statusText = (TextView)findViewById(R.id.status_text);
        Toolbar toolbar =findViewById(R.id.toolbar);
        final Intent mainclass = new Intent(this,Display3dmodelMainActivity.class);
        if (toolbar != null) {
        ...
        openLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent linkBroswer = new Intent(Intent.ACTION_VIEW, Uri.parse(link));
    ...
    private void parseAsset(byte[] assetData) {
        ...
        try {
            ...
            setStatusMessageOnUiThread(response.getString("displayName") + " - Đại học Cần Thơ");
